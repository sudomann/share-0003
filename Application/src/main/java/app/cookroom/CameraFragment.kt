...
/**
 * Reusable Camera Fragment to plug in anywhere
...
class CameraFragment : Fragment(), View.OnClickListener,
    ...
    /**
     * Determines whether to should show UI with rationale for permissions request
     *
    ...
    /**
     * Tries to open a [CameraDevice]. Then [stateCallback] Listens for the reult.
     *
    ...
    private fun startRecordingVideo() {
        ...
        try {
            ...
            // Once the session starts, one can update the UI and start recording
    ...
    /**
     * Using video size with 3:4 aspect ratio.
     * TODO: Aspect ratio should rather be 16:9 or so
     *
